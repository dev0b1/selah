              ...
              <div className="space-y-4 sm:space-y-6 pt-4">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 p-2.5 sm:p-3 bg-[#1a2942]/60 rounded-lg border border-[#8B9DC3]/20">
                    <span className="text-[#D4A574] text-lg sm:text-xl flex-shrink-0">✓</span>
                    <div>
                      <p className="text-[#F5F5F5] font-medium text-sm sm:text-base">AI Worship Songs</p>
                      <p className="text-[#8B9DC3] text-xs sm:text-sm">Generate 1 personalized worship song daily</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 p-2.5 sm:p-3 bg-[#1a2942]/60 rounded-lg border border-[#8B9DC3]/20">
                    ...
                    <div>
                      ...
                      <p className="text-[#8B9DC3] text-xs sm:text-sm">Save and revisit all your prayers and songs</p>
                    </div>
                  </div>
                </div>
