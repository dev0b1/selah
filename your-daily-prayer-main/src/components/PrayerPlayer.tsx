...
export function PrayerPlayer({ prayer, onClose, forFriend }: PrayerPlayerProps) {
        ...
        <div className="max-w-2xl mx-auto">
          {!isSupported ? (
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Button
                onClick={handlePlay}
                className="w-16 h-16 rounded-full gradient-golden text-primary-foreground hover:opacity-90 transition-opacity pulse-soft"
              >
                {isSpeaking && !isPaused ? (
